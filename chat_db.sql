...
--
-- Хост: 127.0.0.1
-- Время создания: Июл 11 2024 г., 10:00
...
(2, 1, 1, 'hbgf', '2024-07-10 13:44:27'),
(3, 4, 1, 'mb nm', '2024-07-10 13:49:34'),
(4, 1, 1, 'hello', '2024-07-10 13:53:22'),
(5, 1, 1, 'hi', '2024-07-10 13:53:28');
...
--
ALTER TABLE `private_messages`
  ADD CONSTRAINT `private_messages_ibfk_1` FOREIGN KEY (`from_user_id`) REFERENCES `users` (`id`),
